...
import com.lunaticapps.tictactoe.databinding.ActivityMain4x4Binding


class MainActivity4x4 : AppCompatActivity(), View.OnClickListener {

    lateinit var binding: ActivityMain4x4Binding
    private lateinit var board: Array<Array<Button>>
    private var PLAYER = true
    private var LAST_GAME_STARTER_PLAYER = true
    private var TURN_COUNT = 0
    private var boardStatus = Array(4) { IntArray(4) }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_main4x4)
        ...
        board = arrayOf(
            arrayOf(binding.R1C1, binding.R1C2, binding.R1C3, binding.R1C4),
            arrayOf(binding.R2C1, binding.R2C2, binding.R2C3, binding.R2C4),
            arrayOf(binding.R3C1, binding.R3C2, binding.R3C3, binding.R3C4),
            arrayOf(binding.R4C1, binding.R4C2, binding.R4C3, binding.R4C4),
        )
    ...
    private fun checkWinner() {
        ...
        if (boardStatus[0][3] == boardStatus[1][2] && boardStatus[0][3] == boardStatus[2][1] && boardStatus[0][3] == boardStatus[3][0]) {
            if (boardStatus[0][3] == 1) {
                ...
                PLAYER1_SCORE += 1
                updateScore()
                board[0][3].setBackgroundResource(R.drawable.winner_button_background)
                board[1][2].setBackgroundResource(R.drawable.winner_button_background)
                board[2][1].setBackgroundResource(R.drawable.winner_button_background)
                board[3][0].setBackgroundResource(R.drawable.winner_button_background)
